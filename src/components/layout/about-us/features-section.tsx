...
export default function Features() {
    return (
        <section className="col-center gap-6 md:gap-20 bg-soria-red py-20 my-20">
            <h2 className='text-soria-cream md:text-8xl text-5xl tracking-tight font-serif '>¿Por qué sabe tan bien?</h2>
            <div className="padding-responsive grid grid-cols-1 md:grid-cols-3 gap-12 text-center divide-y md:divide-y-0 md:divide-x divide-white/20">
                <div className='feature col-center'>
                    <Image src="/feature.svg" alt="alt" width={50} height={50} />
                ...
                <div className='feature col-center'>
                    <Image src="/feature2.svg" alt="alt" width={50} height={50} />
                ...
                <div className='feature col-center'>
                    <Image src="/feature3.svg" alt="alt" width={50} height={50} />
