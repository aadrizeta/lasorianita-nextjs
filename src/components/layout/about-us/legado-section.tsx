        ...
        <section>
            <div className='padding-responsive flex flex-col gap-10 md:flex-row justify-between items-center'>
                <div className='col-center gap-10 w-full max-w-lg'>
                    ...
                    <p className='legado-text'>No utilizamos atajos. Fermentaciones lentas, masa madre cultivada por décadas y el respeto absoluto por el tiempo. Porque las cosas buenas no se pueden apresurar NUEVO</p>
